...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, first_name, middle_name, last_name, email, phone_number, role,gender, password):
...
class ClassSubject(models.Model):
    ...
    teacher = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="teaching_subjects", limit_choices_to={'role': 'teacher'})
